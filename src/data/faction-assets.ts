...
export const REFERENCE_ASSETS: ReferenceAsset[] = [
  ...
  { name: 'Medical Center', type: 'Wealth', rating: 4, category: 'Facility', cost: 12, tl: 4, maxHp: 8, attack: '—', counter: '—', note: 'S', special: 'Between turns, restore a destroyed Special Forces/Military Unit here for half its cost; Repair actions here cost 1 less for those types.', description: 'An advanced medical facility.' },
