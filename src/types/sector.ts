...
export interface SystemObject {
  ...
  orbitDelay?: number;  // seconds to wait before starting orbital motion (for binary stars)
  orbitPhaseOffset?: number;  // starting angle offset in radians (0-2π)
...
export const OBJECT_TYPE_DEFAULTS: Record<ObjectType, Partial<SystemObject>> = {
  ...
  Moon:        { colors: ['#9E9E9E'], size: 0.25, orbitRadius: 8, inclination: 6, selfRotationSpeed: 0.12,
  ...
  AsteroidBelt:{ colors: ['#8C7B6B'], size: 1, orbitRadius: 35, inclination: 2, selfRotationSpeed: 0,    orbitSpeed: 0, axisInclination: 0 },
  SpaceStation:{ colors: ['#B0C4DE'], size: 0.3, orbitRadius: 10,   inclination: 0, selfRotationSpeed: 0.04, orbitSpeed: 0, axisInclination: 0 },
  JumpGate:    { colors: ['#00FFCC'], size: 0.4, orbitRadius: 70, inclination: 0, selfRotationSpeed: 0,    orbitSpeed: 0, axisInclination: 0 },
  Comet:       { colors: ['#E8F4F8'], size: 0.2, orbitRadius: 90, inclination: 25, selfRotationSpeed: 0, seed: 42, isDeepSpace: true, orbitSpeed: 0, axisInclination: 0 },
  Other:       { colors: ['#888888'], size: 0.5, orbitRadius: 25, inclination: 0, selfRotationSpeed: 0,    orbitSpeed: 0, axisInclination: 0 },
